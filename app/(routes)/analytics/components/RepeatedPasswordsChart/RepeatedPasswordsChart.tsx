...
import { RepeatedPasswordsChartProps } from "./RepeatedPasswords.types";
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="items-center pb-0">
        ...
        <CardDescription>
          Puedes revisar tus contraseñas repetidas
        </CardDescription>
      </CardHeader>
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="flex items-center gap-2 leading-none font-medium">
          Intenta no tener las mismas contraseñas{" "}
          <TrendingUp className="h-4 w-4" />
        </div>
        <div className="text-muted-foreground leading-none">
          Visualiza el total de contraseñas creadas
        </div>
      </CardFooter>
    </Card>
  );
